"""
Base IL Training (60%): End-to-end NAVFormer with DiffusionDrive on 60% NavSim data.
"""
import os
...
nav_filter_path_train = os.path.join(WORLDENGINE_ROOT, "projects/AlgEngine/configs/navsim_splits/navtrain_split/navtrain_60pct.yaml")
