"""
Base IL Training (25%): End-to-end NAVFormer with DiffusionDrive on 25% NavSim data.
"""
import os
...
nav_filter_path_train = os.path.join(WORLDENGINE_ROOT, "projects/AlgEngine/configs/navsim_splits/navtrain_split/navtrain_25pct.yaml")
