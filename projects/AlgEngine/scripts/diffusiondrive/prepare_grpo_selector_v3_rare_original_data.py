#!/usr/bin/env python3
"""Prepare the full-navtrain DiffusionDrive V3 rare-original data contract.
...
all-rare plus same-log-common training manifest.  ``rare`` always means a
token selected from the original NAVSIM training data; it never means an
entire log and it never means WorldEngine-generated rollout data.
"""
...
def build_submission(
    ...
    submission = {
        "team_name": "DiffusionDrive-V3-rare-original-mining",
        "authors": ["WorldEngine"],
...
def build_rare_dataset(
    ...
    audit = {
        ...
        "rare_definition": {
            ...
            "low_ego_progress": (
                "safe positive ego_progress strictly below the per-seed "
