#!/usr/bin/env python3
"""Train CPV E1 with a frozen proposal and decision-stratified regret."""
...
E1_RISKS = ("source", "sign", "source_sign")
...
def parse_args():
    ...
    parser.add_argument("--risk-aggregation", choices=E1_RISKS, required=True)
    ...
    args.arbiter_risk = args.risk_aggregation
