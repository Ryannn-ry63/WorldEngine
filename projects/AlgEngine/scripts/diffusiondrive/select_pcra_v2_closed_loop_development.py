#!/usr/bin/env python3
"""Gate the offline-locked PCRA V2 candidate on three-seed closed-loop development."""
...
def main():
    ...
    if (
        ...
        raise RuntimeError("PCRA V2 closed-loop evaluation requires a passed offline gate")
    ...
    report = {
        "schema_version": 1,
        "status": "PASS",
        "method": "pcra_v2_frozen_closed_loop_development_gate",
