#!/usr/bin/env python3
"""Aggregate paired three-seed rare-original, original V3, and epoch-100 results."""
...
def render_markdown(report):
    ...
    for method in ("base", "common_v3", "rare_original_v3"):
        cells = [
...
def main():
    ...
    paths = {
        "rare_original_v3": parse_seed_paths(args.rare, "rare"),
    ...
    report = {
        "schema_version": 1,
        "status": "PASS",
        "comparison": "rare_original_v3_vs_original_common_v3_and_epoch100",
        "aggregate": {
        ...
        "paired_summary_deltas": {
            "rare_minus_common": summary_deltas(
                rows["rare_original_v3"], rows["common_v3"]
            ),
            "rare_minus_base": summary_deltas(
                rows["rare_original_v3"], rows["base"]
            ),
        },
