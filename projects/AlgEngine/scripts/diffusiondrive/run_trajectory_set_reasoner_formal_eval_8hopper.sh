...
export WORLDENGINE_GSPLAT_EXTENSION="${REASONER_SOURCE_WORLDENGINE_ROOT}/artifacts/toolchains/gsplat_sm89_sm90_v1/gsplat/csrc.so"
...
export DIFFUSIONDRIVE_GRPO_EVAL_NOISE_NAMESPACE="reasoner_formal_navtest_seed${EVAL_SEED}"
export DIFFUSIONDRIVE_GRPO_REASONER_ABLATION=relational_only
