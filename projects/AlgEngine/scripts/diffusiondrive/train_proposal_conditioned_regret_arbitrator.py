#!/usr/bin/env python3
"""Train a proposal-conditioned regret arbiter with a frozen scalar proposal."""
...
def parse_args():
    ...
    parser.add_argument("--arbiter-loss", choices=("sign", "regret"), required=True)
    parser.add_argument("--use-decision-context", action="store_true")
