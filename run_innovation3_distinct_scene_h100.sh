...
I3_SETTINGS="$I3_WORKSPACE/registry/online_runtime_owned_subset_20260923.json"
I3_MANIFEST="$I3_WORKSPACE/registry/distinct_scene_pilot_20260923_v1/scene_manifest.json"
...
check_result() {
  "$I3_PYTHON" - "$1" "$2" "$I3_MANIFEST" "$I3_CODE_ROOT" <<'PY'
